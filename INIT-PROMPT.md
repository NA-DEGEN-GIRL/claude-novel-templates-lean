...
### 1.5단계: 전문가 컨셉 평가
시나리오 3개를 **story-consultant 에이전트**로 평가한다. 4개 관점(연재 편집자, 장르 전문가, 캐릭터/감정 편집자, 구조 엔지니어)에서 각 시나리오를 채점하고 리스크를 진단한다.
...
### 2.5단계: 확장 컨셉 재평가
확장된 컨셉(캐릭터, 아크 설계, 핵심 약속)을 **story-consultant 에이전트**로 재평가한다.
...
3. story-consultant 에이전트로 컨셉 평가를 수행해줘 (4개 관점: 연재 편집자, 장르 전문가, 캐릭터/감정, 구조). GO가 나오면 다음으로.
