...
- 에이전트/커맨드 참조를 lean 체계(9 에이전트 + 10 커맨드)로 업데이트한다.
...
> ✅ 완료 기준: ls로 9 agents + 10 commands 존재 확인
...
- `why-checker`: `/why-check plan`을 실행하여 Phase 1.5 OAG(의무 행동 갭 탐지)가 정상 작동하는지 확인
...
| why-checker Phase 1.5 OAG | 의무 행동 갭 탐지 (Generate-Then-Check) |
